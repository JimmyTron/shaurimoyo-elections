...
?> 
    ...
    <h4 class="dark"><i class="fa fa-angle-right"></i><b><?=$poll['title']?></b></h4>
    <b class="dark"><?=$poll['desc']?></b>
    <?php 
    ...
    <p class="dark"><?=$poll_answer['title']?> <span>(<?=$poll_answer['votes']?> Votes)</span></p>
